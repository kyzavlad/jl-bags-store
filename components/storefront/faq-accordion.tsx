...
const DEFAULT_FAQ: FaqItem[] = [
  {
    ...
    a: 'Якщо оплата надійшла до 13:00, відправляємо замовлення того ж робочого дня. Якщо пізніше — наступного робочого дня.',
  },
  {
    q: 'Які способи доставки доступні?',
    a: 'Доставляємо Новою Поштою та Укрпоштою по всій Україні — у відділення, поштомат або кур\'єром на адресу. Для роздрібних замовлень доступна повна оплата або накладений платіж із передоплатою 150 грн; залишок сплачується при отриманні.',
  },
  {
