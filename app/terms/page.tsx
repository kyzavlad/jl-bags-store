    ...
    <>
      ...
      <main className="min-h-screen bg-white">
        <article className="max-w-3xl mx-auto px-6 py-14">
          ...
          <p className="text-xs text-neutral-400 mb-10">Остання редакція: 22 вересня 2026</p>
          ...
          <section className="mb-8">
            ...
            <p className="text-neutral-600 leading-relaxed">
              Для роздрібних замовлень доступна повна оплата або накладений платіж із передоплатою 150 грн; залишок суми сплачується при отриманні на пошті. Доставка
