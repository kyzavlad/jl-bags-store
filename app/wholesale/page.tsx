...
const DROPSHIPPING_ITEMS = [
  ...
  'Оплати до 13:00 відправляються день в день',
  'Є прайс з наявністю',
]
...
const WHOLESALE_FAQ = [
  {
    ...
    a: 'Замовлення, оплачені до 13:00, відправляємо того ж робочого дня. Решта — наступного робочого дня. Відправки здійснюються щодня окрім неділі.',
  },
  {
