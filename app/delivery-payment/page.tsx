...
export const metadata: Metadata = {
  ...
  description:
    'Доставка замовлень JL Bags Новою Поштою та Укрпоштою по всій Україні. Повна оплата або накладений платіж із передоплатою 150 грн. Відправка в день оплати до 13:00 або наступного робочого дня.',
    ...
    <>
      ...
      <main className="min-h-screen bg-white">
        <article className="max-w-3xl mx-auto px-6 py-14">
          ...
          <p className="text-xs text-neutral-400 mb-8">Остання редакція: 22 вересня 2026</p>
          ...
          <section className="mb-12">
            ...
            <Bullets items={[
              'Відправка в день оплати, якщо кошти надійшли до 13:00',
              'Відправки здійснюються щодня окрім неділі',
              'Якщо оплата надійшла після 13:00 — відправка наступного робочого дня',
